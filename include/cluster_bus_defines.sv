...
// MSTER PORT TO TCDM
`define MASTER_0_START_ADDR 32'hB000_0000
`define MASTER_0_END_ADDR   32'hB01F_FFFF

// MASTER PORT TO PERIPHERAL INTERCONNECT
`define MASTER_1_START_ADDR 32'hB020_0000
`define MASTER_1_END_ADDR   32'hB03F_FFFF
